...
- To fully verify the chat/tool path, provide `OPENAI_API_KEY`, start the example app, submit a prompt, confirm `.devtools/generations.json` is created, then inspect it with bounded commands such as:
